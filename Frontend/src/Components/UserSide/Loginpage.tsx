          ...
          <div className="flex-1 bg-black text-white flex flex-col justify-center px-4 sm:px-6 lg:px-12 py-4 md:py-8">
            <div className="max-w-md mx-auto w-full space-y-4 md:space-y-6">
              ...
              <button
                ...
                className="w-full flex cursor-pointer items-center justify-center bg-white hover:bg-gray-50 text-black py-2 sm:py-2.5 px-3 sm:px-4 rounded-lg text-xs sm:text-sm font-semibold space-x-2 sm:space-x-3 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg"
              >
