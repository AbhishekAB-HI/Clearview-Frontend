...
const SideNavBarChat = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-45  border-r border-gray-700  md:top-21 left-0 h-full bg-black text-gray-100 w-60 p-4 space-y-6 shadow-xl
